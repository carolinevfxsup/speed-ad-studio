  ...
  en: {
    ...
    pricing: {
      ...
      growth: {
        ...
        price: '$1,200',
        features: [
          '15 assets (images + videos + carousels)',
          '2 platforms',
          '10-day delivery',
          '2 revisions',
          'Ad copy variations',
      ...
      bespoke: {
        ...
        features: [
          ...
          'Static, video & UGC at scale',
          'Blog & SEO pipeline',
          'Full-funnel integration + reporting',
        ],
      },
    },
    howItWorks: {
  ...
  pt: {
    ...
    pricing: {
      ...
      growth: {
        ...
        price: '$1.200',
        features: [
          '15 recursos (imagens + vídeos + carrosséis)',
          '2 plataformas',
          'Entrega em 10 dias',
          '2 revisões',
          'Variações de copy publicitário',
        ],
      },
      scale: {
        name: 'Escala',
        ...
        features: [
          ...
          'Chamada de estratégia de 30 min',
      ...
      bespoke: {
        ...
        features: [
          ...
          'Estático, vídeo e UGC em escala',
          'Pipeline de blog e SEO',
          'Integração de funil completo + relatórios',
        ],
      },
    },
    howItWorks: {
